...
//    @AttributeOverrides({
//        @AttributeOverride(name = "valueInMicroNaira", column = @Column(name = "discounted_price_in_micro_naira"))
//    })
//    private Money discountedPrice;
//    @AttributeOverrides({
//        @AttributeOverride(name = "valueInMicroNaira", column = @Column(name = "amount_payable_in_micro_naira"))
//    })
//    private Money sum;
...
//    private boolean updateUnitPriceInInventory;
