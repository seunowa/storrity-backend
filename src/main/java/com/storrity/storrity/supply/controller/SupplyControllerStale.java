...
import com.storrity.storrity.supply.service.SupplyServiceStale;
...
//@CrossOrigin
//@RestController
//@RequestMapping("/api/v1/supplies_stale")
//@Tag(name = "Supplies", description = "Operations related to supply management")
public class SupplyControllerStale {
    private final SupplyServiceStale supplyService;

    @Autowired
    public SupplyControllerStale(SupplyServiceStale supplyService) {
    ...
    @ApiResponses({
        @ApiResponse(
            ...
            content = @Content(schema = @Schema(implementation = SupplyDtoStale.class))
        ),
        @ApiResponse(
            responseCode = "400", 
    ...
    @PostMapping
    public SupplyDtoStale create(@RequestBody @Valid SupplyCreationDtoStale dto){
    ...
    @ApiResponses({
        @ApiResponse(
            ...
            content = @Content(
                array = @ArraySchema(schema = @Schema(implementation = SupplyDtoStale.class))
            )
        ),
        @ApiResponse(
            responseCode = "400", 
    ...
    @GetMapping
    public List<SupplyDtoStale> list(@ModelAttribute @Valid  @ParameterObject SupplyQueryParams params){
    ...
    public CountDto count(@ModelAttribute @Valid  @ParameterObject SupplyQueryParams params){
     ...
     @Operation(
            ...
            description = "Update a supply status",
            summary = "Update a supply status by supply ID", 
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses({
        @ApiResponse(
            responseCode = "200",
            description = "Supply status updated successfully",
            content = @Content(schema = @Schema(implementation = SupplyDtoStale.class))
        ),
        @ApiResponse(
            responseCode = "404",
    ...
    @GetMapping(path = "/{id}")
    public SupplyDtoStale fetch(@PathVariable(name = "id") UUID id){
    ...
    public SupplyDtoStale update(@PathVariable(name = "id") UUID id, @RequestBody @Valid SupplyUpdateDtoStale dto){
    ...
    public SupplyDtoStale delete(@PathVariable(name = "id") UUID id){
