...
@NoArgsConstructor
@SuperBuilder
public class MonthlyStockMovementSummaryDto {
    ...
    public MonthlyStockMovementSummaryDto(
            java.sql.Date monthStartDate,
            int year,
            int month,
            long movements,
            double quantityIn,
            ...
            long netValue,
            String baseUnit) {
        this.monthStartDate = monthStartDate.toLocalDate();
        this.year = year;
        this.month = month;
